        ...
        if (flashVer >= 9) {
          a(this).each(function () {
            ...
            if (settings.onInit() !== false) {
              ...
              if (a.browser.msie) {
                ...
                document.getElementById(
                  a(this).attr("id") + "Uploader"
                ).outerHTML = flashElement;
              } else {
                a(this).after(flashElement);
              }
              a("#" + a(this).attr("id") + "Uploader").after(
                '<div id="' +
                  a(this).attr("id") +
                  ...
                  function (r) {
                    for (var p in r) {
                      if (m.data.action(m, l, j, k, o) !== false) {
                        var q = confirm(
                          "Do you want to replace the file '" + r[p] + "'?"
                        );
                        if (!q) {
                          document
                            .getElementById(a(m.target).attr("id") + "Uploader")
                            .cancelFileUpload(p);
                        }
                      }
                    }
            ...
            a(this).bind(
              ...
              function (k, h, j, i) {
                if (k.data.action(k, h, j, i) !== false) {
                  a("#" + a(this).attr("id") + h + " .fileName").text(
                    i.type + " Error - " + j.name
                  );
            ...
            a(this).bind(
              ...
              function (j, h, i, k) {
                if (j.data.action(j, h, i, k) !== false) {
                  a("#" + a(this).attr("id") + h + "ProgressBar").css(
                    "width",
                    k.percentage + "%"
                  );
