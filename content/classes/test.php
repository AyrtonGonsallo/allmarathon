...
function occurences($input)
{
    ...
    $nombres=array($nA,$nB,$nC,$nD,$nE,$nF,$nG,$nH,$nI,$nJ,$nK,$nLL,$nM,$nN,$nO,$nP,$nQ,$nR,$nS,$nT,$nU,$nV,$nW,$nX,$nY,$nZ);
    return $nombres;
}
?>
<?php
function proximité($input,$mot2){
    ...
    $scores=array(1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000);
...
function pourcentage_de_similitude($input,$mot2){
    ...
    $pourcentage=100-(($Ic*100)/((1000*$longueur_valide)?: 1));
