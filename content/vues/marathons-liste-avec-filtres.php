                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 no-padding-left">
                        ...
                        <div>
                            ...
                            <select name="PaysID" id="selected_pays" class="select-pays-front">
                            <option value="">Tous les pays</option>
                                <?php //while($pays = mysql_fetch_array($result4)){
                                    foreach ($liste_pays as $pays_ind) {
                                        echo '<option value="'.$pays_ind['Abreviation'].'">'.$pays_ind['NomPays'].'</option>';
                                    } ?>
                            </select>
                            <input type="text" id="date_debut" class="date-input" placeholder="date début">
                            <input type="text" id="date_fin" class="date-input" placeholder="date fin">
                            <script>
                                $(function() {
