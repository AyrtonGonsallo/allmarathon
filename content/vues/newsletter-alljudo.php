...

{
    ...
    return 'http://www.allmarathon.fr/images/news/' . substr($date, 0, 4) . '/' . $photo;
...

{
    ...
    return 'http://www.allmarathon.fr/actualite-marathon-' . $id . '-' . slugify($title) . '.html';
                            ...
                            <table class="row"
                                ...
                                <tr style="vertical-align: top; text-align: left; padding: 0;" align="left">
                                    ...
                                    <th class="small-12 large-12 first last columns"
                                        ...
                                        <a href="http://www.allmarathon.fr/newsletter-allmarathon.html">

                                            <img width="174" height="66"

                                                 src="http://www.allmarathon.fr/images/logo-news.png"
                                ...
                                <tr style="vertical-align: top; text-align: left; padding: 0;" align="left">
                                    ...
                                    <th class="small-12 large-12 first last columns"
                                        ...
                                        <img width="556" height="143"
                                             ...
                                             src="http://www.allmarathon.fr/images/pubs/<?php echo $pub['image']; ?>" 
                        ...
                        // die;
                            ...
                            foreach ($videos['donnees'] as $key => $video) {
                                ...
                                <td style="width:50%;'.$pad.'" align="left" valign="top">
                                                    ...
                                                    <a href="http://www.allmarathon.fr/video-de-marathon-'.$video['ID'].'.html">
