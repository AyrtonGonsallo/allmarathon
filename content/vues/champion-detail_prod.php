...
$afficher_tab_medaille=false;
   foreach ($tab_med as $key => $value) {
    ...
    if($value['Rang'] < 4)
    {
        ...
        if(empty($tabMedal[$value['CategorieageID']][$value['tri']][$value['Intitule']][$value['Type']][$value['Rang']]))
            $tabMedal[$value['CategorieageID']][$value['tri']][$value['Intitule']][$value['Type']][$value['Rang']] = 1;
        else
            $tabMedal[$value['CategorieageID']][$value['tri']][$value['Intitule']][$value['Type']][$value['Rang']]++;
    }
