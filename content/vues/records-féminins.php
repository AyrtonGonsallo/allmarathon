    ...
    <div class="row banniere1">
        ...
        <div class="row">
            <div class="col-sm-8 left-side resultat-detail page-records">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1>Records du marathon - femmes</h1>
                ...
                <div class="row records-nationaux">
                    ...
                    <div class="table table-responsive lignes-données-nationales">
                            ...
                            foreach ($result1 as $record) {
                                ...
                                $affichage.='<div class="mb-30 national-rec">Détentrice : '.'<a href="athlete-'.$record['champ_id'].'-'.slugify($record['champion']).'.html">'.$record['champion'].'</a>'.'
                                                <br>
                                                Date : 
