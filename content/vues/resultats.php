...
<div class="newsletter">
                    ...
                    <div class="center"><a href="https://allmarathon.fr/formulaire-inscription.php" class="abon-nwl">Je m'abonne</a></div>
                </div>
                ...
                <div class="newsletter">
                    ...
                    <div class="center">
                        <?php if($user_session!=''){?>
                        <a href="https://allmarathon.fr/formulaire-calendrier.php" class="abon-nwl">J'ajoute mon tournoi</a>
                        <?php 
                            }
                            else{ ?>
