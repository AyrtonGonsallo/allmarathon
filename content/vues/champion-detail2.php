...
$afficher_tab_medaille=false;
   foreach ($tab_med as $key => $value) {
    ...
    if($value['Rang'] < 4)
        ...
        if(empty($tabMedal[$value['tri']][$value['Intitule']][$value['Rang']]))
            $tabMedal[$value['tri']][$value['Intitule']][$value['Rang']] = 1;
        else
            $tabMedal[$value['tri']][$value['Intitule']][$value['Rang']]++;
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1 style="border-bottom: 2px solid #cccccc;padding-bottom: 10px;">
                            <?php echo $champ->getNom()." ".$erreur; ?> <span
                                style="float: right;margin-top: -12px;border-bottom: 5px solid #cccccc;">
                        ...
                        <div class="tab-content">
                            ...
                            '.$anecdote; ?>
                                ...
                                <table class="table table-responsive">
                                    ...
                                    <tbody>
                                        <?php ksort($tabMedal, SORT_NUMERIC);
                            ...
                            <div class="tab-pane fade" id="tab3">
								...
								if(sizeof($photos)!=0){
									foreach ($photos as $key => $photo) {
                            			echo '<li><a href=""><img src="/images/galeries/'.$photo['Galerie_id'].'/'.$photo['Nom'].'" width="116" height="77" alt=""/></a></li>';
                            		}} ?>
                            ...
                            <div class="tab-pane fade" id="tab4">
                            	...
                            	foreach ($videos as $key => $vd) {
	                                ...
	                                $event_intitule="<li><a href=''>".$event->getEvenementByID($vd->getEvenement_id())['donnees']->getNom()." ".$annee_event."</a></li>";
	                                }
                                    ...
                                    <ul>
                                        <li class="col-sm-6">
                                            <ul>
                                                <li><a href="">'.$vd->getTitre().'</a></li>'.$event_intitule.$duree.'
                                            </ul>
                                        </li>
                                        <li class="col-sm-6"><a href=""><img src="'.$vd->getVignette().'" width="120" heigh="90" alt="" class="pull-right img-responsive"/></a></li>
                                    </ul>
                                </li>';
                            	}
                            	 ?>
