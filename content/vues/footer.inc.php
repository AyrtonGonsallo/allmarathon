...
<div class="sib-form" style="text-align: center;
  ...
  <div id="sib-form-container" class="sib-form-container">
    <div id="error-message" class="sib-form-message-panel" style="font-size:16px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#661d1d; background-color:#ffeded; border-radius:3px; border-color:#ff4949;max-width:1040px;">
    ...
    <div></div>
    <div id="success-message" class="sib-form-message-panel" style="font-size:16px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#085229; background-color:#e7faf0; border-radius:3px; border-color:#13ce66;max-width:1040px;">
      <div class="sib-form-message-panel__text sib-form-message-panel__text--center">
        <svg viewBox="0 0 512 512" class="sib-icon sib-notification__icon">
    ...
    <div id="sib-container" class="sib-container--large sib-container--horizontal" style="text-align:center; background-color:rgba(242,242,242,1); max-width:1040px; border-radius:3px; border-width:1px; border-color:#f2f2f2; border-style:solid; direction:ltr">
      <form id="sib-form" method="POST" action="https://a7a299f6.sibforms.com/serve/MUIFAJrM3rzrdCMuGUntYoxy9SMgaJEXENagxzWTmFusWDNdRdZU44laVzETYW5fJnoPzmESRYDZb2NH6uq5wtfJV_6yUfdg9b_mz0ERSz8UKCBocNU7xeA-Xj6SnUX_38NPEyVxmWUZJOMs0JvpnLzsKu0l5J0aQB1rtLeoBsAjX-9ji42Iso0EuBBhvARjurk6B2o_O6g1Gkar" data-type="subscription">
        ...
        <div style="padding: 8px 0;">
          <div class="sib-form-block" style="font-size:11px; text-align:center; font-family:&quot;Helvetica&quot;, sans-serif; color:#3C4858; background-color:transparent; text-align:center">
            <div class="sib-text-form-block">
              <p>Pour ne rien manquer des actualités du marathon, rejoignez la communauté allmarathon.fr</p>
            </div>
          </div>
        </div>
        <div class="row">
            ...
            <div class="sib-input sib-form-block">
                ...
                <div class="form__label-row form__label-row--horizontal" style="margin:0">
                    ...
                    <label>
                        ...
                        <span style="float: right;margin-left: 25px;font-size:9px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#3C4858; background-color:transparent;">
                        ...
                        <label class="entry__specification" style="position:relative;top:-22px; font-size:8px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#8390A4; text-align:left">
        ...
        <div style="padding: 8px 0;max-width:600px;margin-left: auto;margin-right: auto;">
          <div class="sib-form__declaration" style="direction:ltr">
            ...
            <p style="font-size:10px; text-align:left; font-family:&quot;Helvetica&quot;, sans-serif; color:#687484; background-color:transparent;">
              Nous utilisons Brevo en tant que plateforme marketing. En soumettant ce formulaire, vous reconnaissez que les informations que vous allez fournir seront transmises à Brevo en sa qualité de processeur de données; et ce conformément à ses <a target="_blank" class="clickable_link" style="font-size: inherit; font-family: inherit; line-height: normal" href="https://www.brevo.com/fr/legal/termsofuse/">conditions générales d'utilisation</a>
            </p>
          </div>
        </div>
            ...
            <div class="row">
                <div class="visible-lg visible-md visible-sm">
                    ...
                    <div class="col-sm-4 ">
                        ...
                        <dd>
                            <ul>
                                <li><a href="http://defi30jours.fr/" target="_blank">Défi 30 jours - développement
                                        personnel</a></li>
                ...
                <div class="visible-xs footer_mobile">
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle " aria-expanded="true" data-toggle="collapse"
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="accordion-toggle" aria-expanded="false" data-toggle="collapse"
