        ...
        <div class="row">
            <div class="col-sm-8 left-side">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                    <a href="/calendrier-agenda-marathons.html">Marathons</a> > Marathons par pays

                        <h1>Calendrier des marathons par pays</h1>
                        <h2>Liste des marathons par pays en <?php echo date("Y");?>/<?php echo date("Y")+1;?></h2>
                    ...
                    foreach (getMarathonsAgendaByPays()['donnees_1'] as $key => $chmp) {
                        echo '<li><a href="calendrier-marathons-'.slugify($chmp['NomPays']).'-'.$chmp['pays_id'].'.html">'.$chmp['NomPays'].'</a></li>';
                    }
                    echo '</ul>';
                    echo '<ul class="col-sm-6 list">';
                    foreach (getMarathonsAgendaByPays()['donnees_2'] as $key => $chmp) {
                        echo '<li><a href="calendrier-marathons-'.slugify($chmp['NomPays']).'-'.$chmp['pays_id'].'.html">'.$chmp['NomPays'].'</a></li>';
                    }
                    echo '</ul>';
                ?>
