                                    ...
                                    <table class="table table-responsive lignes-données">
                                        <tr class="ligne-rec">
                                            <td>
                                                ...
                                                echo 'Détenteur : <a href="athlete-'.$world_best['champ_id'].'-'.slugify($world_best['champion']).'.html">'.$world_best['champion'].'</a>'.' ('.$nom.')';?>

                                            
                                            
                                                <br>
                                                <?php echo 'Date : '.utf8_encode(strftime("%d %B %Y",strtotime($world_best['DateDebut']))).' - Lieu : '.$world_best['evenement'].' ('.$nom.')';?>
                                                <br>
                                    ...
                                    <table class="table table-responsive lignes-données">
                                        <tr class="ligne-rec">
                                            <td>
                                                ...
                                                ($flag!='NULL') ? $pays_flag='<img src="../../images/flags/'.$flag.'" alt=""/>':$pays_flag="";
                                                echo 'Détenteur : <a href="athlete-'.$france_best['champ_id'].'-'.slugify($france_best['champion']).'.html">'.$france_best['champion'].'</a>'.' ('.$nom.')';?>
                                            
                                                <br>
                                                <?php echo 'Date : '.utf8_encode(strftime("%d %B %Y",strtotime($france_best['DateDebut']))).' - Lieu : '.$france_best['evenement'].' ('.$nom.')';?>
                                                <br>
                                                <div class="record-title-colored">
                                    ...
                                    <table class="table table-responsive lignes-données">
                                        <tr class="ligne-rec">
                                            <td>
                                                ...
                                                ($flag!='NULL') ? $pays_flag='<img src="../../images/flags/'.$flag.'" alt=""/>':$pays_flag="";
                                                echo 'Détenteur : <a href="athlete-'.$jo_best['champ_id'].'-'.slugify($jo_best['champion']).'.html">'.$jo_best['champion'].'</a>'.' ('.$nom.')';?>
                                            
                                                <br>
                                                <?php echo 'Date : '.utf8_encode(strftime("%d %B %Y",strtotime($jo_best['DateDebut']))).' - Lieu : '.$jo_best['evenement'].' ('.$nom.')';?>
                                                <br>
                                                <div class="record-title-colored">
                                    ...
                                    <table class="table table-responsive lignes-données">
                                        <tr class="ligne-rec">
                                            <td>
                                                ...
                                                ($flag!='NULL') ? $pays_flag='<img src="../../images/flags/'.$flag.'" alt=""/>':$pays_flag="";
                                                echo 'Détenteur : <a href="athlete-'.$cm_best['champ_id'].'-'.slugify($cm_best['champion']).'.html">'.$cm_best['champion'].'</a>'.' ('.$nom.')';?>
                                            
                                                <br>
                                                <?php echo 'Date : '.utf8_encode(strftime("%d %B %Y",strtotime($cm_best['DateDebut']))).' - Lieu : '.$cm_best['evenement'].' ('.$nom.')';?>
                                                <br>
                                                <div class="record-title-colored">
                                    ...
                                    <table class="table table-responsive lignes-données">
                                        <tr class="ligne-rec">
                                            <td>
                                                ...
                                                ($flag!='NULL') ? $pays_flag='<img src="../../images/flags/'.$flag.'" alt=""/>':$pays_flag="";
                                                echo 'Détenteur : <a href="athlete-'.$ce_best['champ_id'].'-'.slugify($ce_best['champion']).'.html">'.$ce_best['champion'].'</a>'.' ('.$nom.')';?>
                                            
                                                <br>
                                                <?php echo 'Date : '.utf8_encode(strftime("%d %B %Y",strtotime($ce_best['DateDebut']))).' - Lieu : '.$ce_best['evenement'].' ('.$nom.')';?>
                                                <br>
                                                <div class="record-title-colored">
