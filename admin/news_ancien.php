...
session_start();
    ...
    if( isset($_POST['sub']) ){
        ...
        if($erreur == ""){
            ...
            $query2    = sprintf("INSERT INTO news (date,source,titre,titre_en,chapo,texte,photo,categorieID,nom,url,legende,lien1,textlien1,lien2,textlien2,lien3,textlien3,aLaUne,aLaDeux,evenementID,admin) VALUES ('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')"
                ,mysql_real_escape_string($_POST['Date'])
                ,mysql_real_escape_string($_POST['Source'])
                ,mysql_real_escape_string($_POST['Titre'])
                ,mysql_real_escape_string($_POST['Titre_en'])
                ,mysql_real_escape_string($_POST['Chapo'])
                ...
                ,mysql_real_escape_string($_POST['Legende'])
                ,mysql_real_escape_string($_POST['Lien1'])
                ,mysql_real_escape_string($_POST['TextLien1'])
                ,mysql_real_escape_string($_POST['Lien2'])
                ,mysql_real_escape_string($_POST['TextLien2'])
                ,mysql_real_escape_string($_POST['Lien3'])
                ,mysql_real_escape_string($_POST['TextLien3'])
                ,mysql_real_escape_string($_POST['aLaUne'])
                ,mysql_real_escape_string($_POST['aLaDeux'])
                ,mysql_real_escape_string($_POST['EvenementID'])
                ,$_SESSION['login']);
...
<legend>Ajouter news</legend>
    ...
    <table>
    <tr><td align="right"><label>A la une : </label></td><td><input type="radio" name="aLaUne" id="oui" value="1" /><label for="oui">oui</label>&nbsp;&nbsp;&nbsp;<input type="radio" name="aLaUne" id="non" value="0" checked="checked"/><label for="non">non</label></td></tr>
    <tr><td align="right"><label>A la deux : </label></td><td><input type="radio" name="aLaDeux" id="oui" value="1" /><label for="oui">oui</label>&nbsp;&nbsp;&nbsp;<input type="radio" name="aLaDeux" id="non" value="0" checked="checked"/><label for="non">non</label></td></tr>
        <tr><td  align="right"><label for="Date">Date : </label></td><td><input type="text" name="Date" id="timepicker" value="<?php echo date("Y-m-d G:i:s")?>" /></td></tr>
        <tr><td align="right"><label for="Source">Source : </label></td><td><input type="text" name="Source" value="" /></td></tr>
        <tr><td align="right"><label for="Titre">Titre : </label></td><td><input type="text" name="Titre" value="" /></td></tr>
        <tr><td align="right"><label for="Titre_en">Titre englais : </label></td><td><input type="text" name="Titre_en" value="" /></td></tr>
        <tr><td align="right"><label for="Chapo">Chapo : </label></td><td><textarea name="Chapo" cols="50" rows="7"></textarea></td></tr>
        <tr><td  align="right"><label for="Texte">Texte : </label></td><td><textarea name="Texte" cols="30" rows="9"></textarea></td></tr>
        ...
        <tr><td align="right"><label for="categorieID">Type : </label></td><td>
        ...
        <tr><td align="right"><label for="Url">Url : </label></td><td><input type="text" name="Url" value="" /></td></tr>
        <tr><td align="right"><label for="Legende">L�gende : </label></td><td><input type="text" name="Legende" value="" /></td></tr>
        <tr><td align="right"><label for="Lien1">Lien 1 : </label></td><td><input type="text" name="Lien1" value="" /></td></tr>
        <tr><td align="right"><label for="TextLien1">Texte lien 1 : </label></td><td><input type="text" name="TextLien1" value="" /></td></tr>
        <tr><td align="right"><label for="Lien2">Lien 2 : </label></td><td><input type="text" name="Lien2" value="" /></td></tr>
        <tr><td align="right"><label for="TextLien2">Texte lien 2 : </label></td><td><input type="text" name="TextLien2" value="" /></td></tr>

       <tr><td align="right"><label for="Lien3">Lien 3 : </label></td><td><input type="text" name="Lien3" value="" /></td></tr>
        <tr><td align="right"><label for="TextLien3">Texte lien 3 : </label></td><td><input type="text" name="TextLien3" value="" /></td></tr>

        <tr><td align="right"><label for="EvenementID">Evenement : </label></td><td>
        <select name="EvenementID" >
            <option value="0">aucun evenement ...</option>
                <?php while($event = mysql_fetch_array($result2)){
...
<div >
    <table class="tab1">
    <thead>
        <tr><th>ID</th><th>Titre</th><th>Une</th><th>Deux</th><th>Date</th><th>Action</th></tr>
    </thead>
    <tbody>
