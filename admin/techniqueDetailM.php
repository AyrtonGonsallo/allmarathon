...
<?php require_once "menuAdmin.php"; ?>
        <fieldset>
					...
					elseif(isset($_POST['special'])){
						echo "<h1>Ajouter un sp�cialiste</h1>";
					...
					elseif(isset($retour)){ echo '<span style="color:green;">Modification r�ussie</span><br /><br />'; }else{?>
					...
					?>
                        <div ><input type="submit" name="special" value="Ajouter des sp�cialistes"/><?php if(mysql_num_rows($res_spec)!=0){echo '<input type="submit" name="sup_spec" value="Supprimer les sp�cialistes"/>';} ?><input type="submit" name="sub" value="Modifier"/></div>
                </form><div><?php } ?>
                </fieldset>
    </body>
</html>